...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, email, first_name, last_name=None,username=None, password=None,gender=None, **extra_fields):
        if not email:
    ...
    def create_superuser(self, email, first_name, last_name=None,username=None, password=None, **extra_fields):
        ...
        user = self.create_user(clean_email, first_name, last_name,username, password, **extra_fields)
        user.save()
        return user